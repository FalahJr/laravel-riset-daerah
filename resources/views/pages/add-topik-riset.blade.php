    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Tambah Topik Riset</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
                    <div class="breadcrumb-item"><a href="#">Topik Riset</a></div>
                    <div class="breadcrumb-item">Tambah Topik Riset</div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Form Tambah Topik Riset</h4>
                            </div>
                            <form class="form" action="/admin/topik-riset" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
